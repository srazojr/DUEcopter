...
int SCALING_ACCEL_X=-7;//-125 through 140
int SCALING_ACCEL_Y=-1;// -129  t 131
...
void updateAccel(int * dataAccel);// int * dataAccel is a 3 element array head
void updateCompass();
void updateGyro(int* dataGyro);  // int * dataGyro  is a 3 element array head
void updateTemp(int *dataTemp);//get temp, dataTemp is a pointer to one int
double DegreesYaw();//north=0, south +90, west-90
//================================================================
...
dataAccel[2]+=SCALING_ACCEL_Z;
dataAccel[1]+=SCALING_ACCEL_Y;
dataAccel[0]+=SCALING_ACCEL_X;
